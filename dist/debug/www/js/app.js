...
var _gameTemplate = require('@greenhousegames/game-template');

var _gameTemplate2 = _interopRequireDefault(_gameTemplate);

require('@greenhousegames/greenhouse-phaser-plugin');
...
var firebaseInst = _firebase2.default.initializeApp(_config2.default);

var game = new _gameTemplate2.default({
